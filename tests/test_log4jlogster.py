...
class TestLog4jLogster(unittest.TestCase):
    ...
    def test_valid_lines(self):
        ...
        self.assertRaises(
            LogsterParsingException, self.logster.parse_line, self.log_tmpl % "DEBUG"
        )
    ...
    def test_valid_lines_non_default(self):
        ...
        self.assertRaises(
            LogsterParsingException, debug_logster.parse_line, self.log_tmpl % "WARN"
        )
        self.assertRaises(
            LogsterParsingException, debug_logster.parse_line, self.log_tmpl % "ERROR"
        )
